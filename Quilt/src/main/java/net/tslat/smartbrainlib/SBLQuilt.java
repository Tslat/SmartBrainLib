...
public final class SBLQuilt implements SBLLoader {
	...
	private static void registerEntities() {
		SBL_SKELETON = Registry.register(Registry.ENTITY_TYPE, new ResourceLocation(SBLConstants.MOD_ID, "sbl_skeleton"), QuiltEntityTypeBuilder.create(MobCategory.MONSTER, SBLSkeleton::new).setDimensions(EntityDimensions.scalable(0.6f, 1.99f)).build());
