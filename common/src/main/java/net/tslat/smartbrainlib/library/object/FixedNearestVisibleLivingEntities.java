...
/// Wrapper for [NearestVisibleLivingEntities] that supports follow range for entities rather than a hardcoded 16-block limit
///
/// You should be using this instead of `NearestVisibleLivingEntities` in virtually all circumstances
public class FixedNearestVisibleLivingEntities extends NearestVisibleLivingEntities {
    ...
    /// @return An empty [FixedNearestVisibleLivingEntities] instance
