...
/// A movement behaviour for automatically following a given entity.
/// Defaults:
///
...
public class FollowEntity<E extends PathfinderMob, T extends Entity> extends ExtendedBehaviour<E> {
	...
	protected BlockPos getTeleportPos(E entity, T target, BlockPos targetPos) {
		...
		return RandomUtil.positionWithinRange(targetPos, 5, 5, 5, 1, 1, 1, !this.canTeleportOffGround.test(entity), level, 10, (state, statePos) ->
