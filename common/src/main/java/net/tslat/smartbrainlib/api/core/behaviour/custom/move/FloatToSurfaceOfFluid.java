...
public class FloatToSurfaceOfFluid<BO extends Mob> extends ExtendedBehaviour<BO> {
	protected ToFloatFunction<BO> riseChance = _ -> 0.8f;
	protected Predicate<BO> canRise = entity -> entity.isInWater() && entity.getFluidHeight(FluidTags.WATER) > entity.getFluidJumpThreshold() || entity.isInLava();

	/// Set the chance per tick that the entity will 'jump' in water, rising up towards the surface
	///
	/// Higher values result in faster rises
	@ApiStatus.NonExtendable
	public FloatToSurfaceOfFluid<BO> riseChance(float chance) {
		return riseChance(_ -> chance);
	}
	
	/// Set a function to determine the chance per tick that the entity will 'jump' in water, rising up towards the surface
	///
	/// Higher values result in faster rises
	@ApiStatus.NonExtendable
	public FloatToSurfaceOfFluid<BO> riseChance(ToFloatFunction<BO> function) {
		this.riseChance = function;

		return this;
	}
	
	/// Override the predicate that determines whether the entity can float in the current context
	@ApiStatus.NonExtendable
	public FloatToSurfaceOfFluid<BO> canFloatIf(Predicate<BO> predicate) {
		this.canRise = predicate;
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> whenStarting(Consumer<BO> callback) {
		return (FloatToSurfaceOfFluid<BO>)super.whenStarting(callback);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> whenStopping(Consumer<BO> callback) {
		return (FloatToSurfaceOfFluid<BO>)super.whenStopping(callback);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> runFor(int ticks) {
		return (FloatToSurfaceOfFluid<BO>)super.runFor(ticks);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> runFor(int minTicks, int maxTicks) {
		return (FloatToSurfaceOfFluid<BO>)super.runFor(minTicks, maxTicks);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> runFor(ToIntFunction<BO> timeProvider) {
		return (FloatToSurfaceOfFluid<BO>)super.runFor(timeProvider);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> noTimeout() {
		return (FloatToSurfaceOfFluid<BO>)super.noTimeout();
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> cooldownFor(int ticks) {
		return (FloatToSurfaceOfFluid<BO>)super.cooldownFor(ticks);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> cooldownFor(int minTicks, int maxTicks) {
		return (FloatToSurfaceOfFluid<BO>)super.cooldownFor(minTicks, maxTicks);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> cooldownFor(ToIntFunction<BO> timeProvider) {
		return (FloatToSurfaceOfFluid<BO>)super.cooldownFor(timeProvider);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> startCondition(Predicate<BO> predicate) {
		return (FloatToSurfaceOfFluid<BO>)super.startCondition(predicate);
	}
	...
	@ApiStatus.NonExtendable
	@Override
	public FloatToSurfaceOfFluid<BO> stopIf(Predicate<BO> predicate) {
		return (FloatToSurfaceOfFluid<BO>)super.stopIf(predicate);
	}
	//</editor-fold>
	...
	protected boolean checkExtraStartConditions(ServerLevel level, BO entity) {
		return this.canRise.test(entity);
	}
	...
	protected void tick(BO entity) {
		if (entity.getRandom().nextFloat() < this.riseChance.applyAsFloat(entity))
